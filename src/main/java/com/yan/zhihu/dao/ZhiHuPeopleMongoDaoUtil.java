...
public class ZhiHuPeopleMongoDaoUtil {
	...
	public List<ZhiHuPeople> findZhiHuPeopleDocumentsByCondition(Map<String, Object> condition){
		List<ZhiHuPeople> zhiHuPeoples = null;
		...
		if(condition != null && condition.size() > 0) {
			...
			if(docs != null){
				zhiHuPeoples = new ArrayList<ZhiHuPeople>();
				
				for(Document doc : docs){
					ZhiHuPeople zhiHuPeople = new ZhiHuPeople();
					//将document转换为interview
					//System.out.println(doc.get("_id"));
					zhiHuPeople = (ZhiHuPeople)SchameDocumentUtil.documentToSchame(doc, ZhiHuPeople.class);
					
					zhiHuPeoples.add(zhiHuPeople);
				}
			}
		}
	...
	public Long countZhiHuPeopleVoDocumentsByCondition(Map<String, Object> condition){
		long count = 0L;
